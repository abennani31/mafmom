...
import { MAFComponent } from 'app/entities/maf/maf.component';
import { MAFService } from 'app/entities/maf/maf.service';
import { MAF } from 'app/shared/model/maf.model';

describe('Component Tests', () => {
  describe('MAF Management Component', () => {
    let comp: MAFComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mAFS[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
